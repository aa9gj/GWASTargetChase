...
gwasFollowupFull <- function(sumStats, felGTF, pval = 0.00000005, ResultsPath = ".",
  ...
  results_g2d_df <- results_g2d_df[,colSums(is.na(results_g2d_df))<nrow(results_g2d_df)]
  ...
  results_l2g_df <- results_l2g_df[,colSums(is.na(results_l2g_df))<nrow(results_l2g_df)]
  print("writing results")
